...
<div class="form">
  <div class="form-panel one">
		<img src="<?php echo base_url(); ?>/assets/logo2.jpg" width="50px" />  <b>Masukkan Username dan Password Anda</b>
			<hr/>
      <h3><font color="blue">Login User</font></h3>
    ...
    <div class="form-content">
      <form action="<?php echo base_url('login/aksi_login'); ?>" method="post">
		...
		<div class="form-group">
			<center>
				<font color="green">IT Services Application</font>
			</center>
        </div>
      </form>
    </div>
